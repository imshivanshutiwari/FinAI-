...
- Repo: https://github.com/virattt/finai
- FinAI is a CLI-based AI agent for deep financial research, built with TypeScript, Ink (React for CLI), and LangChain.
...
- Config: `.finai/settings.json` (persisted model/provider selection)
...
- Config stored in `.finai/settings.json` (gitignored).
